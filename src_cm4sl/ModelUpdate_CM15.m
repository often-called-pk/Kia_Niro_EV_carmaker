...
OldVersion = 'CarMaker 14.*';
NewVersion = 'CarMaker 15.*';
...
fprintf('=====================================\n');
fprintf('Starting CM4SL models update script\n\n');
...
fprintf('\n');
fprintf('Closing all open CM4SL models\n\n');
bdclose('all');
...
for iFile=1:numel(FileList)
    ...
    try
        ...
        if (IsValidForUpdate(Mdl_FileName, ValidProd, OldVersion, NewVersion)==1)
	    ...
	    %%%%% Add update scripts for the models HERE %%%%%
            ...
            update_PowerTrain_out
            update_PowerTrainUpd_in
...
fprintf('\n');
fprintf('Finishing CM4SL models update script\n');
