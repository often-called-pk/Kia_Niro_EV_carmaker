...
%% Car and Truck Bus
	...
	Simulink.Bus.cellToObject({
	{
		...
		{'RL3', 1,'cm7PowerTrainWheelIn', -1, 'real', 'Sample'};
		{'RR3', 1,'cm7PowerTrainWheelIn', -1, 'real', 'Sample'};
		{'RL4', 1,'cm7PowerTrainWheelIn', -1, 'real', 'Sample'};
		{'RR4', 1,'cm7PowerTrainWheelIn', -1, 'real', 'Sample'};
	    }
	}
	{
	    'cm7PowerTrainWheelOutArray', {
		...
		{'RL3', 1,'cm7PowerTrainWheelOut', -1, 'real', 'Sample'};
		{'RR3', 1,'cm7PowerTrainWheelOut', -1, 'real', 'Sample'};
		{'RL4', 1,'cm7PowerTrainWheelOut', -1, 'real', 'Sample'};
		{'RR4', 1,'cm7PowerTrainWheelOut', -1, 'real', 'Sample'};
	    }
	}
	{
	    'cm7WheelIyyArray', {
	...
	}
	{
		...
		{'d8',	1,'cm7PowerTrainDriveSrc', -1, 'real', 'Sample'};
		{'d9',	1,'cm7PowerTrainDriveSrc', -1, 'real', 'Sample'};
		{'d10',	1,'cm7PowerTrainDriveSrc', -1, 'real', 'Sample'};
		{'d11',	1,'cm7PowerTrainDriveSrc', -1, 'real', 'Sample'};
	    }
	}
	});
    end
