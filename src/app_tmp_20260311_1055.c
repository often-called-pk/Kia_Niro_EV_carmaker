...
static char const *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 14.1.1 2025-07-07", "libcarmaker.a	CarMaker win64 14.1.1 2025-07-07",
    "libipgdriver.a	IPGDriver win64 14.1.1 2025-07-04", "libipgroad.a	IPGRoad win64 14.1.1 2025-07-03",
    "libipgtire.a	IPGTire win64 9.1.1 2024-10-08", NULL};

static char const *CompileFlags[] = {"-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=140101",
    "-DMYMODELS -Wall -Wimplicit -Wmissing-prototypes", "-D__USE_MINGW_ANSI_STDIO -DUNICODE -Wlogical-op",
    "-Wno-address-of-packed-member", NULL};

tAppStartInfo AppStartInfo = {
    "CarMaker 14.1.1 - Car_Generic", /* App_Version         */
    "4", /* App_BuildVersion    */
    "jetbrains", /* App_CompileUser     */
    "2dc68d98a08b", /* App_CompileSystem   */
    "2025-07-07 14:59:59", /* App_CompileTime */
