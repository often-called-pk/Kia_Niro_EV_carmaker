...
Simulink.Bus.cellToObject({
  {
    'cm30WheelInArray', {
      ...
      {'RL3', 		1,'cm30VehicleWheelIn', -1, 'real', 'Sample'};
      {'RR3', 		1,'cm30VehicleWheelIn', -1, 'real', 'Sample'};
      {'RL4', 		1,'cm30VehicleWheelIn', -1, 'real', 'Sample'};
      {'RR4', 		1,'cm30VehicleWheelIn', -1, 'real', 'Sample'};
    }
  }
  {
    'cm30WheelOutArray', {
  ...
  }
  {
    'cm30BrakeWheelArray', {
      ...
      {'RL3', 		1,'cm30VehicleBrakeWheel', -1, 'real', 'Sample'};
      {'RR3', 		1,'cm30VehicleBrakeWheel', -1, 'real', 'Sample'};
      {'RL4', 		1,'cm30VehicleBrakeWheel', -1, 'real', 'Sample'};
      {'RR4', 		1,'cm30VehicleBrakeWheel', -1, 'real', 'Sample'};
    }
  }
  {
    'cm30PTWheelArray', {
      ...
      {'RL3', 		1,'cm30VehiclePTWheel', -1, 'real', 'Sample'};
      {'RR3', 		1,'cm30VehiclePTWheel', -1, 'real', 'Sample'};
      {'RL4', 		1,'cm30VehiclePTWheel', -1, 'real', 'Sample'};
      {'RR4', 		1,'cm30VehiclePTWheel', -1, 'real', 'Sample'};
    }
  }
  {
    'cm30WheelArray', {
