 ...
 */
static void *
MyModel_New(tInfos *Inf, struct tPowerTrainCfgIF *CfgIF, char const *KindKey)
{
...
static int
MyModel_PreSimSetup(void *MP, struct tPowerTrainPreSimIF *PreSimIF, struct tPowerTrainIF *IF)
{
    int iS;
