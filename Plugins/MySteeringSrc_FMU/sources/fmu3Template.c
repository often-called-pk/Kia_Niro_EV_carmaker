/*
 * fmu3Template.c
 * - based on https://github.com/modelica/Reference-FMUs/blob/main/src/fmi3Functions.c
 */
...
fmi3Status fmi3SetDebugLogging(fmi3Instance instance,
    ...
    logDebug(instance, "%s()", __FUNCTION__);
...
fmi3Instance fmi3InstantiateModelExchange(
    ...
    ModelInstance *instance = createModelInstance(
        ...
        ModelExchange);
    if (instance) {
        logDebug(instance, "%s(%s)", __FUNCTION__, instantiationToken);
    }
    return instance;
#endif
}
...
fmi3Status fmi3EnterInitializationMode(fmi3Instance instance,
    ...
    logDebug(instance, "%s(startTime: %f)", __FUNCTION__, startTime);
